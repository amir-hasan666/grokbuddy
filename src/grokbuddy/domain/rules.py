...
TASK_EDGES = {
    ...
    "plan_human_review": ({T.PLAN_REVIEW_PENDING, T.PLAN_REVIEWING}, T.PLAN_HUMAN_REVIEW),
    ...
    "final_human_review": ({T.FINAL_REVIEW_PENDING, T.FINAL_REVIEWING}, T.FINAL_HUMAN_REVIEW),
